                ...
                Button(action: {
                    ...
                    ZStack {
                        if let image = drawingData.savedImage {
                            ...
                            // Display bundled Panda Logo
                            if let bundlePath = Bundle.module.path(forResource: "panda", ofType: "png"),
                               let image = PlatformImage(contentsOfFile: bundlePath) {
                                #if os(iOS)
                                Image(uiImage: image)
                                    .resizable()
                                    .scaledToFit()
